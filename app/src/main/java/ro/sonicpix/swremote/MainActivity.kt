...
import ro.sonicpix.swremote.databinding.ActivityMainBinding
import timber.log.Timber

private const val PERMISSION_REQUEST_CODE = 1

const val sonyId = 0x012D;

val filters = listOf(
    ScanFilter.Builder()
        .setManufacturerData(sonyId, byteArrayOf())
        .build()
)
    ...
    private val connectionEventListener by lazy {
        ConnectionEventListener().apply {
            onConnectionSetupComplete = { gatt ->
                Intent(this@MainActivity, RemoteActivity::class.java).also {
